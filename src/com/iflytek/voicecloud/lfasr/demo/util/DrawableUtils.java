...
public class DrawableUtils {
	...
	public static Image divisionImage(Image backImg, int x, int y, int width, int height) {
//		Image img = getSpaceImage(width, height, null);
		Image img = backImg;
		img.getGraphics().drawImage(backImg, 0, 0, width, height, x, y, x + width, y + height, null);
		return img;
	}
}
